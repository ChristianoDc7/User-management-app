...
export default function Navs() {
  ...
  return (
      <Row className=''>
          <Navbar className="navbar-container grey darken-2 align-center" alignLinks={'right'} brand={<Link to="/" className='brand-logo'><span className='material-icons resize'>badge</span></Link>} menuIcon={undefined} >  
