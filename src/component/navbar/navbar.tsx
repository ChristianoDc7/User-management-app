  ...
  return (
      <Row className=''>
          <Navbar className="navbar-container grey darken-2 align-center" alignLinks={'right'} brand={<Link to="dashboard" className='brand-logo'><span className='material-icons resize'>badge</span></Link>} menuIcon={undefined} >  
              ...
              <NavLink to="message" style={{display:'flex', alignItems:'center'}}><i className='material-icons-outlined tiny'>chat</i><span style={{marginLeft: '2px'}}>Chat</span></NavLink>
              <NavLink to="ogt"><i className="material-icons-outlined tiny" >assessment</i>OGT</NavLink>
              <NavLink to="users" style={{display:'flex', alignItems:'center'}}><i className="material-icons-outlined tiny" >account_circle</i>Users</NavLink>
